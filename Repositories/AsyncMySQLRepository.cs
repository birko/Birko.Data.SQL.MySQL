...
{
    /// <summary>
    /// Async MySQL repository with native async database operations and bulk support.
    /// Uses AsyncMySQLStore which provides bulk operations via transactions.
    /// </summary>
    /// <typeparam name="TViewModel">The type of view model.</typeparam>
    /// <typeparam name="TModel">The type of data model.</typeparam>
    public abstract class AsyncMySQLRepository<TViewModel, TModel>
        ...
        where TViewModel : Models.ILoadable<TModel>
    {
        ...
        /// </summary>
        /// <param name="store">The async MySQL store to use (optional). Can be wrapped (e.g., by tenant wrappers).</param>
